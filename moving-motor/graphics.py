...
plt.plot(times[TIME1*35:TIME1*36], iqs[TIME1*35:TIME1*36], 'r.',label="Iq")
plt.plot(times[TIME1*35:TIME1*36], vqs[TIME1*35:TIME1*36], 'b.',label="Vqs")
plt.legend()
plt.grid()
plt.show()
...
axs[0, 0].plot(times[:TIME1*60], ids[:TIME1*60], 'g.', label="Id")
axs[0, 0].plot(times[:TIME1*60], iqs[:TIME1*60], 'r.',label="Iq")
...
axs[0, 1].plot(times[:TIME1*60], vds[:TIME1*60],'g.', label="Vd")
axs[0, 1].plot(times[:TIME1*60], vqs[:TIME1*60],  'r.',label="Vq")
...
axs[1, 0].plot(times[:TIME1*60], velocitys[:TIME1*60],'g.', label="Velocity")
axs[1, 0].plot(times[:TIME1*60], positions[:TIME1*60],'r.', label="Position")
...
axs[1, 1].plot(times[:TIME1*60], temps_measured[:TIME1*60],'y.')
